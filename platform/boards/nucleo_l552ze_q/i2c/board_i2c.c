...
/* Timing values for 110 MHz PCLK (from STM32 I2C timing tool) */
#define I2C1_TIMING_STANDARD   0x10909CECU  /* 100 kHz */
#define I2C1_TIMING_FAST       0x00702991U  /* 400 kHz */
#define I2C1_TIMING_FAST_PLUS  0x00300F38U  /* 1 MHz   */
...
static int board_i2c1_apply_config(void *ctx, i2c_speed_t speed, i2c_addr_mode_t addr_mode)
{
    ...
    uint32_t timing = I2C1_TIMING_STANDARD;
    switch (speed) {
