...
#error "BOARD_HAS_SENSORS is defined but BOARD_MAX_SENSORS is 0. Set BOARD_MAX_SENSORS to the number of sensors in your board CMakeLists.txt."
#endif

#if defined(BOARD_HAS_SENSORS) && (BOARD_MAX_SUBS == 0)
#error "BOARD_HAS_SENSORS is defined but BOARD_MAX_SUBS is 0. Set BOARD_MAX_SUBS to the total number of subscriber slots needed."
#endif
 ...
 */
typedef void (*sensor_data_cb_t)(int handle, const void *data,
        int status, void *ctx);
